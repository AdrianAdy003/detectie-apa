...
// Link către pagina de profil/rating Google Business (afișat pe badge-ul "5,0 pe Google").
export const GOOGLE_BUSINESS_PROFILE_URL = 'https://share.google/Cu7fZXh0wvGNx8vis';
